...
function onePageScroll(element, options) {
	...
	this.destroy = function() {
		...
		_removeClass(el, "onepage-wrapper")
		for( var i = 0; i < sections.length; i++){
			_removeClass(sections[i], "ops-section")
		}

		_removeClass(body, "viewing-page-1");
		_removeClass(body, "viewing-page-2");
		_removeClass(body, "viewing-page-3");
		_removeClass(body, "viewing-page-4");
